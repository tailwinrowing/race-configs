module.exports = function (rawRows) {
    ...
    while (i < rawRows.length) {
        ...
        if ((eventRow.a && eventRow.a.trim().startsWith('Results Event')) || (eventRow.b && eventRow.b.trim().startsWith('Results Event'))) {
            let currentEvent = eventRow.a.trim().replace(/Results Event\s*#\s*:?\s*/i, 'Event ');
